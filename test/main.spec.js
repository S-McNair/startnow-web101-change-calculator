...
describe('Change Calculator', function () {
  ...
  describe('Integration', () => {
    ...
    //     .wait('#dollars-output')
    //     .evaluate(() => ({
    //       //dollars: document.querySelector('#dollars-output').innerHTML,
    //       quarters: document.querySelector('#quarters-output').innerHTML,
    //       dimes: document.querySelector('#dimes-output').innerHTML,
    //       nickels: document.querySelector('#nickels-output').innerHTML,
    //       pennies: document.querySelector('#pennies-output').innerHTML,
    //     }))
    //     .end()
    //     .then(change => {
